...
1. Clone the repo
   ...
   ```shell
    git clone https://github.com/amit-c1308/Lyriks-Music-app.git
   ```
...
You've found a bug in the source code, a mistake in the documentation or maybe you'd like a new feature? You can help us by [submitting an issue on GitHub](https://github.com/amit-c1308/Lyriks-Music-app/issues). Before you create an issue, make sure to search the issue archive -- your issue may have already been addressed!
...
4. Go to [Pull Requests](https://github.com/amit-c1308/Lyriks-Music-app/pulls) and click on the `New Pull Request` button.
